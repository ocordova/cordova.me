...
This post covers the first two layers. In [the next post](/thoughts/evaluating-stocks-2-the-scoring-engine) I walk through the scoring engine: the weights, thresholds, and how the two evaluations combine. In the [third](/thoughts/evaluating-stocks-3-the-hypothesis), I cover the forward-looking hypothesis that asks where the world is going and whether it favors this business.
