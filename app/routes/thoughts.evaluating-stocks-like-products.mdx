...
**Problem.** How severe is the problem this company solves? Inspired by Ash Maurya's Running Lean, I ask: Is it must-have or nice-to-have? What are the consequences if nobody solves it? Is regulation mandating a solution? A company whose product is legally required has a fundamentally different risk profile from one selling a convenience.
