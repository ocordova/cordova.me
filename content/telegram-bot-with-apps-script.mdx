...
<div className="flex justify-center">
  <Image
    height={1920 / 4}
    width={1080 / 4}
    src={`/images/writing/search-for-the-user-botfather.jpeg`}
...
<div className="flex justify-center">
  <Image
    height={1920 / 4}
    width={1080 / 4}
    src={`/images/writing/start-conversation-with-botfather.jpeg`}
...
<div className="flex justify-center">
  <Image
    height={1920 / 4}
    width={1080 / 4}
    src={`/images/writing/list-of-commands-supported-by-botfather.jpeg`}
...
<div className="flex justify-center">
  <Image
    height={1920 / 4}
    width={1080 / 4}
    src={`/images/writing/give-your-bot-a-name.jpeg`}
...
<div className="flex justify-center">
  <Image
    height={1920 / 4}
    width={1080 / 4}
    src={`/images/writing/give-your-bot-a-username.jpeg`}
...
<div className="flex justify-center">
  <Image
    height={1920 / 4}
    width={1080 / 4}
    src={`/images/writing/telegram-bot-token.jpeg`}
...
<div className="flex justify-center">
  <Image
    height={661}
    width={1147}
    src={`/images/writing/create-your-google-apps-script-project.jpeg`}
...
1. Click **Deploy**.
   <div className="flex justify-center">
     <Image
       height={454}
       width={448}
       src={`/images/writing/deploy-as-web-app.jpeg`}
...
<div className="flex justify-center">
  <Image
    height={172}
    width={439}
    src={`/images/writing/authorization-required.jpeg`}
...
<div className="flex justify-center">
  <Image
    height={368}
    width={485}
    src={`/images/writing/request-for-permission.jpeg`}
...
<div className="flex justify-center">
  <Image
    height={1920 / 4}
    width={1080 / 4}
    src={`/images/writing/testing-our-bot.jpeg`}
    alt={`Testing out bot`}
  />
</div>
## We’re done!
