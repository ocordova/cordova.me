...
hero_image_alt: 'Jekyll and tailwind css logos'
embeddedImagesLocal:
  - jekyll-quickstart.jpg
  - jekyll-with-tailwind.jpg
---
...
<GatsbyImage alt="Jekyll quickstart" image={getImage(props.localImages[0])} />
