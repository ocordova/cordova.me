...
embeddedImagesLocal:
  - search-for-the-user-botfather.jpg
  - start-conversation-with-botfather.jpg
  - list-of-commands-supported-by-botfather.jpg
  - give-your-bot-a-name.jpg
  - give-your-bot-a-username.jpg
  - telegram-bot-token.jpg
  - create-your-google-apps-script-project.jpg
  - deploy-as-web-app.jpg
  - authorization-required.jpg
  - request-for-permission.jpg
  - testing-our-bot.jpg
---
...
<video controls muted>
  <source src="/telegram-bot-demo.mp4" type="video/mp4" />
  <source src="/telegram-bot-demo.ogg" type="video/ogg" />
</video>
...
<GatsbyImage
  ...
  image={getImage(props.localImages[9])}
/>
...
<GatsbyImage
  objectFit="contain"
  alt="Testing our bot"
  image={getImage(props.localImages[10])}
/>
