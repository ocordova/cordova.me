...
export default (props) => <ArticleLayout back={false} meta={meta} {...props} />
...
<video autoPlay muted width="320" height="240" >
  <source src="/static/blog/telegram-bot-demo.mp4" type="video/mp4" />
  <source src="/static/ webblog/telegram-bot-demo.ogg" type="video/ogg" />
</video>
</div>
