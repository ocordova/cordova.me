...
export const meta = {
    ...
    date: '2023-02-24',
    title: 'Why is it essential to use a Prioritization Framework for Spring backlogs?',
    description:
    ...
    cover: '/static/articles/why-is-it-essential-to-use-a-prioritization-framework-for-spring-backlogs.jpeg',
