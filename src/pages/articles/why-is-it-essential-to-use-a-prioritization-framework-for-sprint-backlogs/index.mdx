...
export const meta = {
    ...
    cover: '/static/articles/why-is-it-essential-to-use-a-prioritization-framework-for-sprint-backlogs.jpeg',
    coverAlt: 'A window with a a kanban board made of post-it notes',
}
...
[Cover image by İrfan Simsar from Unsplash](https://unsplash.com/photos/wxWulfjN-G0)