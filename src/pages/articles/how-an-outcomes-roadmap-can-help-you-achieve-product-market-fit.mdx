...
export const meta = {
  ...
  cover: '/static/articles/how-an-outcomes-roadmap-can-help-you-achieve-product-market-fit.jpeg',
  coverAlt: 'Two puzzle pieces fitting together',
}
...
[Image by Vardan Papikyan from Unsplash](https://unsplash.com/photos/JzE1dHEaAew)